                                        ...
                                        <div class="media-body">
                                            <div class="row">
                                                ...
                                                <div class="col-3 text-center centered">
                                                    <a href="${pageContext.request.contextPath}/admin/produtos/editar/${produto.id}"
                                                       class="btn btn-primary">Editar</a>
                                                </div>
                                                <div class="col-3 centered text-right">
                                                    <a href="${pageContext.request.contextPath}/admin/produtos/remover/${produto.id}"
...
<script>
    if (location.search === '?erro=fk') {
        alert('Voc� n�o pode remover esse produto, pois ele j� foi incluido em um pedido!');
    }
</script>
