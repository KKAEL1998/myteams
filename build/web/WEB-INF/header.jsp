        ...
        <nav class="navbar bg-info navbar-expand-sm navbar-dark justify-content-between">
            ...
            <ul class="navbar-nav">
                ...
                <c:if test="${sessionScope.usuario != null}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/conta">Olá,  ${sessionScope.usuario.nome}! Acesse sua conta</a>
                    </li>
                ...
                <c:if test="${sessionScope.carrinho != null}">
                    <li class="nav-item">
                        <a class="btn btn-secondary" href="${pageContext.request.contextPath}/carrinho">Carrinho <span class="badge badge-light">${sessionScope.carrinho.quantidadeItens}</span></a>
                    </li>
                </c:if>
