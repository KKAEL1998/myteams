                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <c:if test="${produto != null}">
                                        <img id="imagemUpload" style="width: 100%" src="${produto.imagem}" alt="Imagem"/>
                                    </c:if>
                                    <c:if test="${produto == null}">
                            ...
                            <form method="POST">
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea id="descricao" type="text" class="form-control" name="descricao" required>${produto.descricao}</textarea>
                                    </div>
                                    <input id="imagem" type="text" style="display: none" class="form-control" name="imagem"  value="${produto.imagem}" required>
                                    <input id="id" type="text" style="display: none" class="form-control" name="id"  value="${produto.id}">
                                    <div class="form-group col-6">
                                        <label for="preco">Preço</label>
                                        <input id="preco" class="form-control" name="preco" autofocus  value="${produto.preco}" required > 
                                    </div>
