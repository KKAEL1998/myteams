        ...
        <div class="col-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <a href="${pageContext.request.contextPath}/admin/novo-produto"
                               class="btn btn-primary d-block"><i class="fas fa-plus"></i> Novo Produto</a>
                        </div>
                        <div class="col">
                            <a href="${pageContext.request.contextPath}/admin/novo-admin"
                               class="btn btn-primary d-block"><i class="fas fa-user-plus"></i> Novo Administrador</a>
                        </div>
                        <div class="col">
                            <a href="${pageContext.request.contextPath}/admin/produtos" class="btn btn-primary d-block"><i
                                    class="fas fa-user-plus"></i> Alterar/Excluir Produtos</a>
                        </div>
                        <div class="col">
                            <a href="${pageContext.request.contextPath}/admin/nova-categoria"
                               class="btn btn-primary d-block"><i class="fas fa-user-plus"></i> Nova Categoria</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="accordion" id="accordionExample">
                                <c:forEach items="${pedidos}" var="pedido">
                                    <div class="card">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <button class="btn btn-link collapsed" type="button"
                                                                ...
                                                                data-target="#collapsePedido${pedido.id}"
                                                                aria-expanded="false"
                                                                aria-controls="collapsePedido${pedido.id}">
                                        ...
                                        <div id="collapsePedido${pedido.id}" class="collapse"
                                             aria-labelledby="headingPedido${pedido.id}"
